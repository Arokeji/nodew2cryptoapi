...
const insertCryptos = async () => {
  try {
    ...
    console.log("Cryptos insertados correctamente");
  } catch (error) {
    console.log("Error al insertar los datos de las cryptos: " + error);
  }
};

const deleteAndInsertCryptos = async () => {
  try {
...
module.exports = { deleteAndInsertCryptos };
